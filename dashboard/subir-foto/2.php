          ...
          <div class="principal">
            ...
            <section class="photo-upload__data">
              <div class="input__container">
                <input type="text" id="card-name" class="input__item" value="" placeholder="Agregá etiquedas como: naturaleza, retrato, paisaje, rio *">
              </div>
            </section>
          </div>
          <div class="button">
            <article class="save__container">
              <a href="<?= WEBSITE_URL; ?>/dashboard/subir-foto/1" class="btn">Anterior</a>
              <a href="<?= WEBSITE_URL; ?>/dashboard/subir-foto/3" class="btn btn__filled--blue">Guardar</a>
            </article>
          </div>
        </section>
      </div>
